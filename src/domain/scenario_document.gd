...
func create_guided_mission_template(scenario_id:String,world:Dictionary,definitions:Array[Dictionary],terrain=null)->bool:
	...
	candidate.sequences.append({"sequence_id":"begin_route","enabled":true,"one_shot":true,"event":{"type":"unit_enters_region","group_id":"player_party","region_id":"start_checkpoint"},"conditions":[{"type":"sequence_has_run","sequence_id":"mission_start","value":true}],"actions":[{"type":"show_tutorial","tutorial_id":"move_to_allies"}]})
